...
genderCommand5 = 'python '+relativePath+'guess.py --class_type age --model_type inception --model_dir '+relativePath+'../_checkpoints/22801/ --face_detection_type dlib --face_detection_model '+relativePath+'shape_predictor_68_face_landmarks.dat                --filename ' + sys.argv[1]
genderCommand6 = 'python '+relativePath+'guess.py --class_type age --model_type inception --model_dir '+relativePath+'../_checkpoints/22801/                            --face_detection_model '+relativePath+'../darkflow/haar/haarcascade_frontalface_default.xml --filename ' + sys.argv[1]
...
for lineNum in range(len(lines)):
  ...
  if prefix in line:
    ...
    predictedAge = line[openIndex:closeIndex+1]
    #print("debug - predicted age is " + predictedAge)
    print(predictedAge)
